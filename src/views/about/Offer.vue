  ...
  <div>
    ...
    <!-- <app-content-section class="overflow-hidden" color="light-greyish">
      ...
      >
        <div class="content-wrapper">
          <div class="row row-centered">
            <div
              class="col col-6 col-large-7 col-large-after-1 col-wrapping col-large-no-bottom-margin"
            >
      ...
      <div class="content-wrapper scroll-effect content-subsection">
        <div class="row">
          <div
            class="col col-tablet-portrait-7 col-large-6 col-large-before-5 col-wrapping col-large-no-bottom-margin"
          >
            <h2 class="heading centered left-aligned-large" id="community">
              {{ $t("section-community-heading") }}
            </h2>
            <p v-html="$t('section-community-text')"></p>
            <ul>
              <li
                style="font-weight:700;"
                v-html="$t('section-community-listitem-1')"
              ></li>
              <li
                style="font-weight:700;"
                v-html="$t('section-community-listitem-2')"
              ></li>
              <li
                style="font-weight:700;"
                v-html="$t('section-community-listitem-3')"
              ></li>
              <li
                style="font-weight:700;"
                v-html="$t('section-community-listitem-4')"
              ></li>
              <li
                style="font-weight:700;"
                v-html="$t('section-community-listitem-5')"
              ></li>
              <li
                style="font-weight:700;"
                v-html="$t('section-community-listitem-6')"
              ></li>
            </ul>
      ...
      <div class="content-wrapper scroll-effect content-subsection">
        <div class="row row-centered">
          <div class="col">
            <p class="centered lead">
              <b>{{ $t("section-community-promo-text") }}</b>
            </p>
    ...
    <!-- <app-content-section class="overflow-hidden">
      ...
      <div class="content-wrapper scroll-effect">
        <div class="row">
          <div
            class="col col-tablet-portrait-7 col-large-6 col-large-before-1 col-wrapping col-large-no-bottom-margin"
          >
            <h2 class="heading centered left-aligned-large" id="knowledge">
              {{ $t("section-knowledge-heading") }}
            </h2>
