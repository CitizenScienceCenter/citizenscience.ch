      ...
      <!--<div class="content-subsection">
        <div class="content-wrapper">
          <div class="row row-centered row-reverse-large row-middle">
            ...
            <div
              class="col col-large-5 col-large-before-1 col-wrapping col-no-bottom-margin scroll-effect"
            >
              <h3 class="subheading centered left-aligned-large">
                {{ $t("section-collaborations-openseventeen-subheading") }}
                <p
                  class="lead"
                  v-html="$t('section-collaborations-openseventeen-lead')"
                ></p>
              </h3>
              ...
              <div class="centered left-aligned-large">
                <button
                  ...
                  @click="openInNewTab('http://openseventeen.org')"
                >
       ...
       <div class="content-subsection">
        <div class="content-wrapper">
          <div class="row row-centered row-middle">
            <div
              class="col col-large-6 col-wrapping col-large-no-bottom-margin scroll-effect scroll-effect-delayed-1"
            >
              <div class="extra-padding-h">
            ...
            <div
              class="col col-large-5 col-large-after-1 col-wrapping col-no-bottom-margin scroll-effect"
            >
              <h3 class="subheading centered left-aligned-large">
                {{ $t("section-collaborations-toolkit-heading") }}
                <p
                  class="lead"
                  v-html="$t('section-collaborations-toolkit-lead')"
                ></p>
              </h3>
          ...
          <div class="row row-centered row-reverse-large row-middle">
            ...
            >
              ...
              <button
                ...
                @click="openInNewTab('https://snakes.citizenscience.ch')"
              >
                Visit the Project
              </button>
            </div>
