  ...
  <div id="top">
    ...
    <!-- <app-content-section class="overflow-hidden">
      ...
      <div class="content-wrapper">
        <div class="row">
          <div
            class="col col-tablet-portrait-7 col-large-6 col-large-before-5 col-wrapping col-large-no-bottom-margin scroll-effect"
          >
            <h2 class="heading centered left-aligned-large" id="projects">
    ...
    <app-content-section color="light-greyish">
      <div class="content-wrapper">
        <div class="row row-centered">
          ...
          <div
            class="col col-tablet-portrait-10 col-large-4 col-wrapping col-large-no-bottom-margin scroll-effect"
          >
            <div class="row row-centered">
              <div
          ...
          <div
            class="col col-tablet-portrait-10 col-large-4 col-wrapping col-no-bottom-margin scroll-effect scroll-effect-delayed-2"
          >
            <div class="row row-centered">
              <div
                class="col col-6 col-tablet-portrait-4 col-large-6 extra-margin-bottom"
    ...
    <app-content-section>
      <div class="content-subsection">
        <div class="content-wrapper">
          <div
            class="row row-centered row-middle row-reverse-large row-wrapping"
          >
            ...
            <div class="col col-large-6 col-large-before-1 col-wrapping">
              <h2 class="subheading centered left-aligned-large">
                {{ $t("section-projects-checklist-heading") }}
              </h2>
              <p
                v-html="$t('section-projects-checklist-text')"
              ...
              <div class="button-group centered left-aligned-large">
                <router-link
                  ...
                  to="/start/checklist"
                  class="button button-secondary"
                  >{{ $t("section-projects-checklist-button") }}</router-link
                >
              </div>
            </div>
          </div>
        ...
        <div class="content-wrapper">
          <div class="row row-centered row-middle row-wrapping">
            ...
            <div class="col col-large-6 col-large-after-1 col-wrapping">
              <h2 class="subheading centered left-aligned-large">
                {{ $t("section-projects-phases-heading") }}
              </h2>
              <p
                v-html="$t('section-projects-phases-text')"
                class="reduced-bottom-margin"
              ></p>
              <div class="button-group centered left-aligned-large">
                <router-link
                  ...
                  to="/start/phases"
                  class="button button-secondary"
                  >{{ $t("section-projects-phases-button") }}</router-link
                >
              </div>
            </div>
          </div>
